...
public class TestLocPieChartActivity extends Activity {

    private static int[] COLORS = new int[] { Color.WHITE, Color.WHITE,
            Color.WHITE, Color.WHITE, Color.CYAN, Color.YELLOW, Color.DKGRAY };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_loc_pie_chart);
        mLinear = (LinearLayout) findViewById(R.id.pic_chart);
...
//        mRenderer.setChartTitle("饼图示例");// 设置饼图标题
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            mRenderer.setChartTitleTextSize(18);// 设置饼图标题大小
